...
type JobsKubernetesConfig struct {
	CacheStorageClass string `json:"cacheStorageClass,omitempty" bson:"cacheStorageClass"`
	AllowSecretKeyRef bool   `json:"allowSecretKeyRef,omitempty" bson:"allowSecretKeyRef"`
