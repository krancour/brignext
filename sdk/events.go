...
type Event struct {
	// ObjectMeta encapsulates Event metadata.
	...
	// to subscriptions. For instance, no subscribers to the "GitHub" Source and
	// the "push" Type is likely to want to hear about push events for ALL
	...
	// subscription from all push events emitted by the GitHub gatewat to just
	...
	// Git encapsuates git-specific Event details. These can be used to override
	...
	// exists for any Project to express any interest in any or all Events. This
	...
	// Worker encapsulates a concrete plan for handling the Event. This is
	// generated by the system. Clients MUST leave the value of this field nil
	// when using the API to create an Event.
	Worker *WorkerSpec `json:"worker,omitempty"`
	// Kubernetes encapsulates Kubernetes-specific details of the Event's Worker's
	...
	// Status encapsulates Event status details.
...
// EventStatus represent's an Event's current state.
type EventStatus struct {
	// WorkerStatus encapsulates details of the Event's Worker's state.
	WorkerStatus WorkerStatus `json:"workerStatus"`
	// JobStatuses is a map of Job names to details of Job state.
	JobStatuses map[string]JobStatus `json:"jobStatuses,omitempty"`
}
