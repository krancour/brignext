...
func (e *eventsEndpoints) list(w http.ResponseWriter, r *http.Request) {
	...
	if workerPhasesStr != "" {
		...
		selector.WorkerPhases = make([]WorkerPhase, len(workerPhaseStrs))
		for i, workerPhaseStr := range workerPhaseStrs {
			selector.WorkerPhases[i] = WorkerPhase(workerPhaseStr)
		}
	}
	e.ServeRequest(
		apimachinery.InboundRequest{
...
func (e *eventsEndpoints) startWorker(w http.ResponseWriter, r *http.Request) {
	e.ServeRequest(
		apimachinery.InboundRequest{
			W: w,
			R: r,
...
func (e *eventsEndpoints) getOrStreamWorkerStatus(
	w http.ResponseWriter,
	r *http.Request,
) {
	id := mux.Vars(r)["id"]
...
func (e *eventsEndpoints) updateWorkerStatus(w http.ResponseWriter, r *http.Request) {
	status := WorkerStatus{}
	e.ServeRequest(
		apimachinery.InboundRequest{
			W:                   w,
...
func (e *eventsEndpoints) createJob(w http.ResponseWriter, r *http.Request) {
	jobSpec := JobSpec{}
	e.ServeRequest(
		apimachinery.InboundRequest{
			W:                   w,
...
func (e *eventsEndpoints) startJob(w http.ResponseWriter, r *http.Request) {
	e.ServeRequest(
		apimachinery.InboundRequest{
			W: w,
			R: r,
...
func (e *eventsEndpoints) getOrStreamJobStatus(
	w http.ResponseWriter,
	r *http.Request,
) {
	id := mux.Vars(r)["id"]
...
func (e *eventsEndpoints) updateJobStatus(
	w http.ResponseWriter,
	r *http.Request,
) {
	status := JobStatus{}
...
func (e *eventsEndpoints) streamLogs(
	w http.ResponseWriter,
	r *http.Request,
) {
	id := mux.Vars(r)["id"]
